...
import xyz.sumeshmajhi.www.sakam.Odisha_map;
...
public class Odisha_State_deatils extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.odisha );
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              Intent intent = new Intent(Odisha_State_deatils.this,Assam_map.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment( new Odisha_ashram(), "ASHRAM SCHOOLS" );
        adapter.addFragment( new Odisha_eklavya(), "EKALVYA SCHOOLS" );
